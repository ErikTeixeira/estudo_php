...
<body class="bg-gray-600 min-vh-100">
    <div id="app" class="min-vh-100">
        <nav class="navbar navbar-expand-md navbar-dark bg-dark shadow sm:rounded-lg bg-gray-300">
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        @else
                            <li class="nav-item dropdown">
                                <a id="navbarDropdown" class="nav-link dropdown-toggle text-blue" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                    {{ Auth::user()->name }}
                                </a>
